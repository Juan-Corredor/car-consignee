...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler
	  ...
	  protected ResponseEntity<ErrorResponse> handleException(InvalidDataException exc) {
	    ...
	    return buildResponseEntity(httpStatus, new RuntimeException("The data sent is not valid"), errors);
	  }
	  ...
	  protected ResponseEntity<ErrorResponse> handleException(Exception exc) {
	    ...
	    return buildResponseEntity(httpStatus, new RuntimeException("A problem has arisen, please report it and try again later."));
	  }
